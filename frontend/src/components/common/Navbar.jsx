    ...
    <header className="h-16 bg-token-card border-b border-token-border px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shrink-0">
      ...
      <div className="flex items-center gap-3 flex-1 max-w-md">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <img src={logoImg} alt="SupportSense" className="w-7 h-7 rounded-lg object-cover shadow-2xs" />
          <span className="font-bold text-xs text-token-text-primary hidden sm:inline">SupportSense</span>
        </div>
